...
import { BadRequestError, IBuyerDocument, IEducation, IExperience, ISellerDocument } from '@jobhunt-microservices/jobhunt-shared';
...
class SeedController {
  ...
  randomEducation = (count: number): IEducation[] => {
